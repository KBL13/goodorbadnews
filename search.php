        ...
        <div id="page-wrapper">
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <form style="font-size:120%;" action="add.php" method="post">
                        <div class="form-group">
                            <input type="text" id="search" name="search" placeholder="Enter Stock Symbol here..." class="form-control" required="required" oninvalid="this.setCustomValidity('This field is required.' )" oninput="setCustomValidity('')">
                        </div>
                        <div class="panel-footer">
                            <div class="row">
                                <div class="col-sm-offset-5 col-sm-2">
                                    <button class="btn btn-lg btn-primary btn-block" type = "submit" name="searchbutton">Add</button>
                                </div>
                            </div>
                        </div>
                    </form>
